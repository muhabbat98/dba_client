  ...
  return (
    <Container>
      <AddProductFormContainer>
        ...
        <AddProductFormItem>
          <ProductTitle fSize={16} title="Общая характеристика" />
          <AddProductFormItemBody>
            <AddProductFormItemBodyItem>
              <Input
                name="typeOfOwnership"
        ...
        <AddProductFormItem>
          <ProductTitle fSize={16} title="Экран" />
          <AddProductFormItemBody>
            <AddProductFormItemBodyItem>
              <Dropdown
                option={[
        ...
        <AddProductFormItem>
          <ProductTitle fSize={16} title="Связь" />
          <AddProductFormItemBody>
            <AddProductFormItemBodyItem>
              <Dropdown
                option={[
        ...
        <AddProductFormItem>
          <ProductTitle fSize={16} title="Камера смартфона" />
          <AddProductFormItemBody>
            <AddProductFormItemBodyItem>
              <Dropdown
                option={[
        ...
        <AddProductFormItem>
          <ProductTitle fSize={16} title="Питание и процессор смартфона" />
          <AddProductFormItemBody>
            <AddProductFormItemBodyItem>
              <Input
                name="typeOfOwnership"
