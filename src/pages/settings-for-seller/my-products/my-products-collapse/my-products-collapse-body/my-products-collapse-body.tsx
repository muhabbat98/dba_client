...
import {
   MyProductsCollapseBodyContainer, MyProductsCollapseTitle, MyProductsCollapseImgWrapper,
   MyProductsCollapseImgItem, MyProductsDetailsWrapper, MyProductsDetailsItem, ActivateButtons,
   ...
   return (
      <MyProductsCollapseBodyContainer>
         ...
         <MyProductsDetailsWrapper>
            ...
            <MyProductsDetailsItem>Samsung / Смартфон Galaxy A51 128Gb</MyProductsDetailsItem>
         </MyProductsDetailsWrapper>
         ...
         <MyProductsDetailsWrapper>
            <MyProductsDetailsItem>Количество проданного товара</MyProductsDetailsItem>
