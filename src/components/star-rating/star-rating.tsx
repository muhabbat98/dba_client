      ...
      <StarRatingContainer >
         <StarRatingUl>
            ...
            [1, 2, 3, 4, 5].map((item,index) => {
                  return (
                     <StarRatingLi data-star={item} >
                        <svg fill={inputStar>index?starColor:"transparent"} width="15px" height="15px" stroke={starColor} viewBox="0 0 24 24"
                           xmlns="h ttp://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            :
               [1, 2, 3, 4, 5].map(item => {
                  return (
                     <StarRatingLi data-star={item} onMouseEnter={handleHover} onClick={handleClick}>
